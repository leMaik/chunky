...
public class SeaPickleModel extends QuadModel {
  ...
  private static final Quad[] seaPickle2Pickle = {
      ...
      new Quad(new Quad(
          ...
          new Vector4(1 / 16.0, 3 / 16.0, 11 / 16.0, 16 / 16.0)),
          Transform.NONE.translate(3.0 / 16.0, 2.4 / 16.0, 3.0 / 16.0)
              .rotateY(Math.toRadians(45))
              .translate(-3.0 / 16.0, -2.4 / 16.0, -3.0 / 16.0)),
      new Quad(new Quad(
          new Vector3(4.5 / 16.0, 5.2 / 16.0, 5 / 16.0),
          new Vector3(5.5 / 16.0, 5.2 / 16.0, 5 / 16.0),
      ...
      new Quad(new Quad(
          ...
          new Vector4(1 / 16.0, 3 / 16.0, 11 / 16.0, 16 / 16.0)),
          Transform.NONE.translate(-2.0 / 16.0, 0, -2.0 / 16.0)
              .rotateY(Math.toRadians(45))
              .translate(2.0 / 16.0, 0, 2.0 / 16.0)),
      new Quad(new Quad(
          new Vector3(9.5 / 16.0, 3.2 / 16.0, 10 / 16.0),
          new Vector3(10.5 / 16.0, 3.2 / 16.0, 10 / 16.0),
  ...
  private static final Quad[] seaPickle3Pickle = {
      ...
      new Quad(new Quad(
          ...
          new Vector4(1 / 16.0, 3 / 16.0, 11 / 16.0, 16 / 16.0)),
          Transform.NONE.translate(0, 0, -3.0 / 16.0)
              .rotateY(Math.toRadians(45))
              .translate(0, 0, 3.0 / 16.0)),
      new Quad(new Quad(
          new Vector3(7.5 / 16.0, 5.2 / 16.0, 11 / 16.0),
          new Vector3(8.5 / 16.0, 5.2 / 16.0, 11 / 16.0),
      ...
      new Quad(new Quad(
          ...
          new Vector4(1 / 16.0, 3 / 16.0, 11 / 16.0, 16 / 16.0)),
          Transform.NONE.translate(4.0 / 16.0, 0, 4.0 / 16.0)
              .rotateY(Math.toRadians(45))
              .translate(-4.0 / 16.0, 0, -4.0 / 16.0)),
      new Quad(new Quad(
          new Vector3(3.5 / 16.0, 3.2 / 16.0, 4 / 16.0),
          new Vector3(4.5 / 16.0, 3.2 / 16.0, 4 / 16.0),
  ...
  private static final Quad[] seaPickle4Pickle = {
      ...
      new Quad(new Quad(
          ...
          new Vector4(1 / 16.0, 3 / 16.0, 11 / 16.0, 16 / 16.0)),
          Transform.NONE.translate(-3.0 / 16.0, 0, -4.0 / 16.0)
              .rotateY(Math.toRadians(45))
              .translate(3.0 / 16.0, 0, 4.0 / 16.0)),
      new Quad(new Quad(
          new Vector3(10.5 / 16.0, 3.2 / 16.0, 12 / 16.0),
          new Vector3(11.5 / 16.0, 3.2 / 16.0, 12 / 16.0),
      ...
      new Quad(new Quad(
          ...
          new Vector4(1 / 16.0, 3 / 16.0, 11 / 16.0, 16 / 16.0)),
          Transform.NONE.translate(4.0 / 16.0, 0, -2.0 / 16.0)
              .rotateY(Math.toRadians(45))
              .translate(-4.0 / 16.0, 0, 2.0 / 16.0)),
      new Quad(new Quad(
          new Vector3(3.5 / 16.0, 6.2 / 16.0, 10 / 16.0),
          new Vector3(4.5 / 16.0, 6.2 / 16.0, 10 / 16.0),
