...
import static se.llbit.chunky.world.BlockData.*;
...
public class TripwireModel extends QuadModel {
  ...
  static {
    ...
    model[CONNECTED_EAST | CONNECTED_SOUTH | CONNECTED_WEST] = Model.rotateY(model[CONNECTED_NORTH | CONNECTED_EAST | CONNECTED_SOUTH]);
    model[CONNECTED_SOUTH | CONNECTED_WEST | CONNECTED_NORTH] = Model.rotateY(model[CONNECTED_EAST | CONNECTED_SOUTH | CONNECTED_WEST]);
    model[CONNECTED_WEST | CONNECTED_NORTH | CONNECTED_EAST] = Model.rotateY(model[CONNECTED_SOUTH | CONNECTED_WEST | CONNECTED_NORTH]);
    model[CONNECTED_NORTH | CONNECTED_SOUTH] = tripwireNS;
    model[CONNECTED_EAST | CONNECTED_WEST] = Model.rotateY(model[CONNECTED_NORTH | CONNECTED_SOUTH]);
    model[CONNECTED_NORTH | CONNECTED_EAST] = tripwireNE;
    model[CONNECTED_EAST | CONNECTED_SOUTH] = Model.rotateY(model[CONNECTED_NORTH | CONNECTED_EAST]);
    model[CONNECTED_SOUTH | CONNECTED_WEST] = Model.rotateY(model[CONNECTED_EAST | CONNECTED_SOUTH]);
    model[CONNECTED_WEST | CONNECTED_NORTH] = Model.rotateY(model[CONNECTED_SOUTH | CONNECTED_WEST]);
