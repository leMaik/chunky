    ...
    if (textureRotation == 90) {
      primitives.add(
          new TexturedTriangle(
              c0, c2, c1, new Vector2(u1, v0), new Vector2(u0, v0), new Vector2(u1, v1), material, false));
      primitives.add(
          new TexturedTriangle(
              c1, c2, c3, new Vector2(u1, v1), new Vector2(u0, v0), new Vector2(u0, v1), material, false));
    } else if (textureRotation == 180) {
      primitives.add(
          new TexturedTriangle(
              c0, c2, c1, new Vector2(u1, v1), new Vector2(u1, v0), new Vector2(u0, v1), material, false));
      primitives.add(
          new TexturedTriangle(
              c1, c2, c3, new Vector2(u0, v1), new Vector2(u1, v0), new Vector2(u0, v0), material, false));
    } else if (textureRotation == 270) {
      primitives.add(
          new TexturedTriangle(
              c0, c2, c1, new Vector2(u0, v1), new Vector2(u1, v1), new Vector2(u0, v0), material, false));
      primitives.add(
          new TexturedTriangle(
              c1, c2, c3, new Vector2(u0, v0), new Vector2(u1, v1), new Vector2(u1, v0), material, false));
    } else {
      primitives.add(
          new TexturedTriangle(
              c0, c2, c1, new Vector2(u0, v0), new Vector2(u0, v1), new Vector2(u1, v0), material, false));
      primitives.add(
          new TexturedTriangle(
              c1, c2, c3, new Vector2(u1, v0), new Vector2(u0, v1), new Vector2(u1, v1), material, false));
    }
  }
