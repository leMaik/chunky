...
If you want to get the latest snapshots, make sure to tick the _Download snapshots_ checkbox before checking for updates. Snapshots are built automatically from the [master branch](https://github.com/chunky-dev/chunky/commits/master) and the [stable branch](https://github.com/chunky-dev/chunky/commits/chunky-2.4.x).

For more detailed instructions, please take a look at the [Installing Chunky guide](https://chunky-dev.github.io/docs/getting_started/installing_chunky/) in the Chunky Manual.
